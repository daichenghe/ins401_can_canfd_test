...
class NTRIPClient(EventBase):
    def __init__(self, properties):
        ...
        print(properties["ntrip"], type(properties["ntrip"]))

        self.ip = properties["ntrip"]["host"]
        self.port = properties["ntrip"]["port"]
        self.mountPoint = properties["ntrip"]["mountPoint"]
        self.username = properties["ntrip"]["username"]
        self.password = properties["ntrip"]["password"]
        print(self.ip, self.port, self.mountPoint, self.username, self.password)
    def run(self):
        print('NTRIP run..')
        while True:
            if self.is_close:
